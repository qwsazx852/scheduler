...
prompt_text = """请分析这张图片，判断它是「收据/发票」还是「工作出勤表」。
...
system_message = """你是一个专业的「加油站排班经理」。你的职责是管理一份包含14位员工的 Google Sheet 班表，并协助将班表同步到 Google Calendar。
...
# Raw JSON output strings for Set nodes
json_output_image = """={
...
workflow = {
    ...
    "connections": {
        "Webhook": {"main": [[{"node": "Check Message Type", "type": "main", "index": 0}]]},
        "Check Message Type": {
            "main": [
                [{"node": "Get Image Content", "type": "main", "index": 0}],
                [{"node": "Format Text Command", "type": "main", "index": 0}]
            ]
        },
        "Get Image Content": {"main": [[{"node": "Gemini Vision", "type": "main", "index": 0}]]},
        "Gemini Vision": {"main": [[{"node": "Format Image Command", "type": "main", "index": 0}]]},
        "Format Image Command": {"main": [[{"node": "Date & Time", "type": "main", "index": 0}]]},
        "Format Text Command": {"main": [[{"node": "Date & Time", "type": "main", "index": 0}]]},
        "Date & Time": {"main": [[{"node": "AI Agent", "type": "main", "index": 0}]]},
        ...
        "Read Schedule": {"ai_tool": [[{"node": "AI Agent", "type": "ai_tool", "index": 0}]]},
        "Update Schedule": {"ai_tool": [[{"node": "AI Agent", "type": "ai_tool", "index": 0}]]}
    },
    "active": True,
    "settings": {
        "executionOrder": "v1"
...
with open('/Users/jun/.gemini/antigravity/scratch/n8n_dynamic_agent_v4.json', 'w') as f:
    json.dump(workflow, f, indent=4, ensure_ascii=False)
    
print("Successfully generated n8n_dynamic_agent_v4.json")
